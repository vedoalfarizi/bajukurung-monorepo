...
- [ ] 3. AWS infrastructure — API Gateway, Cognito, CloudFront
  ...
  - [x] 3.3 Define CloudFront distribution serving frontend S3 bucket and product images S3 bucket
    - _Requirements: 6.5_
  - [x] 3.4 Add staging and production stack namespaces (separate environments)
    - _Requirements: 6.9_
...
- [ ] 11. Frontend — product browsing pages
  ...
  - [x] 11.4 Implement `SizeChartTable`: render bust/waist/hip ranges per Standard Size from product's sizeChart; include AllSize descriptive note
    - _Requirements: 2.3_
